...
abstract contract EquitoApp is IEquitoReceiver {
    ...
    function setPeers(uint256[] calldata chainSelectors, bytes64[] calldata addresses) external  {
    ...
    function _setPeers(uint256[] calldata chainSelectors, bytes64[] calldata addresses) internal virtual  {
